...
import static Utils.CapitalizeWords.capitalizeWords;
...
public class InputCheck {
    ...
    public static String requestString(String message, String errorMessage) {
        while (true) {
            String input = capitalizeWords(JOptionPane.showInputDialog(null, message, "Input", JOptionPane.QUESTION_MESSAGE));
            try {
